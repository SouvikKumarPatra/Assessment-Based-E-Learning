    ...
    <header class="site-navbar py-4 js-sticky-header site-navbar-target" role="banner">
      ...
      <div class="container-fluid">
        <div class="d-flex align-items-center">
          <div class="site-logo mr-auto w-25"><a href="index.php">Academy</a></div>
        ...
        <div class="row">
          ...
          <div class="owl-carousel col-12 nonloop-block-14">
            ...
            <div class="course bg-white h-100 align-self-stretch">
              <figure class="m-0">
                <img src="images/ml.jpg" alt="Image" class="img-fluid">
              </figure>
            ...
            <div class="course bg-white h-100 align-self-stretch">
              ...
              <div class="course-inner-text py-4 px-4">
                ...
                <p>Mastering Data Structures & Algorithms using C, Java, C++ · Python for Data Structures </p>
              </div>
              <div class="d-flex border-top stats">
            ...
            <div class="course bg-white h-100 align-self-stretch">
              <figure class="m-0">
                <img src="images/dl.jpg" alt="Image" class="img-fluid">
              </figure>
              <div class="course-inner-text py-4 px-4">
                <span class="course-price">$0</span>
                <div class="meta"><span class="icon-clock-o"></span>4 Lessons / 12 week</div>
                <h3><a href="#">Deep Learning</a></h3>
                <p>Deep Learning is one of the most highly sought after skills in AI . </p>
              </div>
              <div class="d-flex border-top stats">
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="100">
            <div class="teacher text-center">
              <img src="images/person1.jpg" alt="Image" class="img-fluid w-50 rounded-circle mx-auto mb-4">
              <div class="py-2">
                <h3 class="text-black">Souvik Patra</h3>
          ...
          <div class="col-md-6 col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="200">
            <div class="teacher text-center">
              <img src="images/person2.jpg" alt="Image" class="img-fluid w-50 rounded-circle mx-auto mb-4">
              <div class="py-2">
                <h3 class="text-black">Abidi Sing</h3>
          ...
          <div class="col-md-6 col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="300">
            <div class="teacher text-center">
              <img src="images/person3.jpg" alt="Image" class="img-fluid w-50 rounded-circle mx-auto mb-4">
              <div class="py-2">
                <h3 class="text-black">Santu</h3>
      ...
      <div class="container">
        <div class="row justify-content-center align-items-center">
          <div class="col-md-8 text-center testimony">
            <img src="images/person4.jpg" alt="Image" class="img-fluid w-25 mb-4 rounded-circle">
            <h3 class="mb-4">Abhishek Mondal</h3>
            <blockquote>
